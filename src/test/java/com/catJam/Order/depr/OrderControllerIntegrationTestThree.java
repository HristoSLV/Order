...
//public class OrderControllerIntegrationTestThree {
//
//    @Autowired
...
//        OrderEntity order1 = new OrderEntity(null, 1L, 100.0, LocalDate.of(2024, 8, 13), Arrays.asList(1L, 2L, 3L));
//        OrderEntity order2 = new OrderEntity(null, 2L, 150.0, LocalDate.of(2024, 8, 14), Arrays.asList(4L, 5L));
//
...
//        OrderEntity newOrder = new OrderEntity(null, 3L, 200.0, LocalDate.of(2024, 8, 15), Arrays.asList(6L, 7L));
//
...
//        assertEquals(LocalDate.of(2024, 8, 15), createdOrder.getOrderDate());
...
//        OrderEntity savedOrder = orderRepository.save(new OrderEntity(null, 1L, 100.0, LocalDate.of(2024, 8, 13), Arrays.asList(1L, 2L, 3L)));
//
//        OrderEntity updatedOrder = new OrderEntity(savedOrder.getId(), 1L, 250.0, LocalDate.of(2024, 8, 16), Arrays.asList(8L, 9L));
//
